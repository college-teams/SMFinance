    ...
    <div className="absolute bg-secondaryBg top-1/2 left-1/2  -translate-x-1/2 -translate-y-1/2 py-12 px-10 rounded w-full md:w-[30%] " >
      <form>
        <div className="relative flex flex-col mb-8 gap-y-2">
          <label htmlFor="username" className="relative text-[1.2rem]">Email</label>
          <input type="email" id="username" className="relative py-2" />
        </div>
        <div className="relative flex flex-col mb-10 gap-y-2">
          <label htmlFor="password" className="relative text-[1.2rem]">Password</label>
